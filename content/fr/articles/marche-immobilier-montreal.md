...
**1. Le taux d'absorption**
C'est le ratio des propriétés vendues par rapport aux inscriptions actives, exprimé en pourcentage. Au-dessus de 25%: marché de vendeurs. Entre 15% et 25%: marché équilibré. En dessous de 15%: marché d'acheteurs.

**2. Les jours sur le marché**
Combien de temps faut-il en moyenne pour vendre une propriété? Une baisse de ce chiffre signale une demande en hausse. Une hausse indique un ralentissement du marché.

**3. Le ratio prix demandé / prix vendu**
Les propriétés se vendent-elles au-dessus, à, ou en dessous du prix demandé? Ce ratio vous indique immédiatement si vous êtes dans un marché de négociation ou de compétition.

**4. Les décisions de taux de la Banque du Canada**
Le taux directeur influence directement les taux hypothécaires variables. Il influence les taux fixes indirectement via le marché obligataire.

**5. Les données d'immigration et de formation de ménages**
Montréal accueille une part significative de la population immigrante du Québec. Chaque ménage formé crée une demande de logement.

## Ce que les données actuelles montrent (2025)

Le marché de la grande région de Montréal a traversé trois phases distinctes depuis 2020:

- **2020-2022:** Expansion puis surchauffe, portée par des taux d'intérêt historiquement bas.
- **2022-2023:** Correction. Les hausses agressives de taux de la Banque du Canada ont réduit significativement le pouvoir d'achat.
- **2024-2025:** Reprise progressive. La Banque a commencé à réduire ses taux en 2024. L'activité est revenue à des niveaux plus normaux.
...
- Les propriétés à Laval restent moins chères que les propriétés comparables sur l'île de Montréal, malgré un accès au transport équivalent ou meilleur dans plusieurs secteurs.
- Le taux d'inoccupance est constamment inférieur à 3%, bien en dessous du niveau d'équilibre que la SCHL identifie comme "sain".
- La demande locative est forte et diversifiée.
- Les investissements en infrastructure (autoroutes, transports) maintiennent Laval bien connectée au noyau économique de Montréal.

## Pourquoi les prix ne vont probablement pas s'effondrer
...
- Avez-vous votre mise de fonds plus 3 à 5% pour les frais de fermeture?
- Prévoyez-vous de rester au moins 5 à 7 ans?
- Les propriétés que vous regardez sont-elles à un prix juste selon les ventes comparables récentes?
