...
- Une banque ou un prêteur fournit les 80% à 95% restants sous forme de prêt
- Vous remboursez le prêt mensuellement sur 25 à 30 ans, avec intérêts
...
## Bâtir un historique de crédit: commencez maintenant
...
1. Ouvrez un compte bancaire canadien immédiatement
2. Demandez une carte de crédit sécurisée (nécessite un dépôt, mais commence à bâtir votre dossier)
3. Payez chaque solde en totalité et à temps, chaque mois
4. Évitez de demander plusieurs produits de crédit simultanément
...
## Le CELIAPP: ouvrez-en un maintenant
...
- Vérifie que le vendeur est légalement le propriétaire
- Vérifie s'il y a des hypothèques, privilèges ou charges légales sur le titre
...
- Demander une carte de crédit sécurisée et l'utiliser de façon responsable
- Ouvrir un compte CELIAPP dès que vous êtes admissible
- Commencer à épargner régulièrement

**Année 2:**
- Votre dossier de crédit commence à s'établir
- Continuer à bâtir des épargnes dans votre CELIAPP
- Consulter un spécialiste hypothécaire sur votre potentiel de qualification
