...
| | Trois mois d'intérêts | Différentiel de taux d'intérêt |
|---|---|---|
| Base de calcul | Solde impayé et votre taux | Écart entre deux taux, sur le temps restant |
| Ce qui le fait grossir | Un solde élevé | Un taux courant nettement plus bas que le vôtre |
| Quand il s'applique | Toujours calculé | Quand votre taux dépasse les taux courants |
| Sensible au terme restant | Non | Oui, fortement |

L'ACFC ajoute que le différentiel entre en jeu quand votre taux hypothécaire est
plus élevé que les taux en vigueur et que le contrat a moins de cinq ans. Retenez
...
La méthode que décrit l'ACFC compte cinq gestes.

1. Prenez le solde impayé.
2. Prenez le nombre de mois qui restent au terme.
3. Calculez les intérêts qui restent à payer à votre taux.
4. Recalculez les mêmes intérêts au taux de comparaison retenu par le prêteur.
5. Faites la différence. C'est le différentiel.

**L'exemple chiffré de l'agence donne la mesure de l'écart.** Solde impayé de
200 000 $, taux de 6 %, 36 mois restants sur un terme de cinq ans, taux affiché
...
|---|---|---|---|
| Trois mois d'intérêts | Sans objet | 300 000 $ x 5 % / 4 | 3 750 $ |
| Taux au contrat contre taux affiché courant | 1,00 point | 300 000 $ x 1 % x 2,5 ans | 7 500 $ |
...
| Radiation : quittance, mainlevée | 165 $ par réquisition |
...
plus seulement un taux. Plafonds, assurance perdue et frais sont détaillés dans
