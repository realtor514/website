...
## The lender is not looking at your salary, it is looking at two ratios
...
## Why your neighbour on the same income is approved for more
...
## The down payment changes the whole calculation
...
## And the costs the lender's calculation ignores
...
- Transfer duties, commonly called the welcome tax, payable a few months after purchase
- Notary fees, the inspection and the move
- Municipal and school taxes, if you were previously renting
- Maintenance, often estimated at around 1% of the property value per year
...
1. Run a first estimate with the [affordability calculator](/en/tools/affordability/) and the [mortgage calculator](/en/tools/mortgage/) to see how price and down payment affect your payment.

2. Get a real pre-approval from a lender or mortgage broker. It is free, it locks a rate for a set period, and it is what gives you weight when you make an offer. A pre-approval is worth infinitely more than an online simulation.
...
To go further, read [the real cost of buying your first home in Quebec](/en/articles/vrai-cout-achat-premiere-maison-quebec/) and [the pre-approval mistakes to avoid](/en/articles/mortgage-preapproval-mistakes/).
