...
Data and analysis beat gut feeling in most areas of real estate. But there are specific situations where the analytical conclusion is clear: walk away from this property, regardless of how appealing the price or how much you love the kitchen.
...
## 4. A Price Significantly Below Comparable Properties With No Explanation
...
But a property priced 15-20%+ below comparable recent sales with no disclosed explanation for the discount should trigger deep investigation before any offer. Unexplained bargains in the residential market are usually either situations where the seller knows something the buyer doesn't, or conditions that have been disclosed but downplayed.
...
## 5. Significant Discrepancy Between Listed Area and Actual Area

In Quebec, residential properties are marketed with a listed living area. This area is not always accurate. Listings exist where the stated square footage is overstated by 15-20% relative to what the property actually contains.
...
Before any offer, calculate the implied price-per-square-foot and compare it to recent comparable sales. Significant divergence is a signal to verify the area independently.

## The Difficult Truth About Red Flags
...
The value of a checklist like this is that it holds when emotions are making the decision. In these five situations, the answer is the same: step back and think carefully before you proceed.
