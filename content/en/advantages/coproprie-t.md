---
title: "Coproprie-T: A Broker Trained in Condominium Law"
description: "RE/MAX Québec's exclusive training program developed with Me Yves Joli-Coeur and CondoLegal.com, for divided and undivided co-ownership transactions."
program: "Coproprie-T"
eyebrow: "Exclusive RE/MAX Québec Training"
logo: "images/protections/coproprie-t.png"
accent: "navy"
official: "https://www.remax-quebec.com/en/coproprie-t"
weight: 3
cardTitle: "Coproprie-T"
cardText: "Continuing education in condominium law, developed with CondoLegal.com. For divided and undivided condo transactions."
draft: false
facts:
  - value: "CondoLegal"
    label: "Training partner"
  - value: "Divided"
    label: "Divided co-ownership covered"
  - value: "Undivided"
    label: "Undivided co-ownership covered"
  - value: "Ongoing"
    label: "Continuous knowledge updates"
---
...
1. I request the full syndicate file, not just the account statement.
2. I read the minutes of the last several general meetings, not just the most recent one.
3. I assess the contingency fund against the age and components of the building.
4. I check whether what you want to do with the unit is actually allowed by the declaration.
5. I flag what deserves a notary's or lawyer's opinion before you commit.
