...
## El prestamista no mira su salario, mira dos razones
...
## Por qué su vecino con el mismo salario es aprobado por más
...
## El pago inicial cambia todo el cálculo
...
## Y los costos que el cálculo del prestamista ignora
...
- Los derechos de mutación, llamados comúnmente impuesto de bienvenida, pagaderos unos meses después de la compra
- Los honorarios del notario, la inspección y la mudanza
- Los impuestos municipales y escolares, si antes alquilaba
- El mantenimiento, que suele estimarse alrededor del 1 % del valor de la propiedad por año
- Las cuotas de condominio, si se trata de un condominio
...
1. Haga una primera estimación con la [calculadora de capacidad de compra](/es/tools/affordability/) y la [calculadora hipotecaria](/es/tools/mortgage/) para ver el efecto del precio y del pago inicial sobre su cuota.

2. Obtenga una preaprobación real con un prestamista o un corredor hipotecario. Es gratuita, bloquea una tasa por un período determinado y es lo que le da peso al momento de hacer una oferta. Una preaprobación vale infinitamente más que una simulación en línea.
...
Para completar, lea [el costo real de comprar su primera vivienda en Quebec](/es/articles/vrai-cout-achat-premiere-maison-quebec/) y [la guía hipotecaria para primeros compradores](/es/articles/guide-hypotheque-premier-acheteur-quebec/).
