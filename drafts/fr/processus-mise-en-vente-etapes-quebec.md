...
Le premier rendez-vous ne vous engage à rien. La journée où vous signez, par
contre, vous remplissez deux documents dans la même séance.
...
si la case reste vide, le contrat prend fin 30 jours après sa conclusion. Le
détail des clauses est ailleurs: lisez
...
est vague, obtenir les factures et permis qui appuient vos déclarations, et
mettre le formulaire à jour dès qu'un élément nouveau apparaît. Ce que vous
écrivez là suivra le dossier jusque chez le notaire:
...
**Dès la signature du contrat de courtage**, le courtier est responsable de
vérifier si vous possédez un certificat de localisation, quel âge il a, quels
ajouts ou modifications ont été faits depuis son émission, et d'en examiner le
contenu. S'il n'y en a pas, s'il n'est plus valide ou s'il ne reflète pas l'état
actuel des lieux, il doit vous recommander d'en faire produire un nouveau.
...
prend du temps, et ce temps varie selon la région et la période de l'année.
C'est pour cela qu'on s'en occupe à la signature du contrat de courtage, pas le
jour où une promesse d'achat arrive.
...
spéciale, un changement réglementaire, il doit corriger la fiche et les
Déclarations du vendeur au moyen d'un formulaire *Modifications*.
...
énumérer tous les éléments inclus et exclus qui ne figuraient pas à la promesse
initiale. L'entente qui vous lie sera la promesse telle que modifiée par la
dernière contre-proposition, sans tenir compte des versions intermédiaires.

L'OACIQ recommande de donner suite à toutes les promesses reçues, même pour les
refuser. Attention toutefois: refuser une promesse conforme aux conditions
inscrites à votre contrat de courtage est l'un des cas qui rendent la
rétribution du courtier exigible.
...
|---|---|---|
| Fin du contrat de courtage | Contrat de courtage, clause 2.1 | La date que vous inscrivez, 30 jours si la case reste vide |
| Certificat de localisation | Norme de pratique, article 2 | Vérifié dès la signature; la production par l'arpenteur varie |
...
avez déclarés, et à le purger des hypothèques qui le grèvent. C'est de là que
vient la quittance: votre prêteur doit consentir à la radiation de son
hypothèque au registre foncier.
...
Mais si la promesse était conforme aux conditions inscrites à votre contrat de
courtage, le refus est l'un des cas qui rendent la rétribution du courtier
exigible. Faites vérifier la conformité avant de répondre.
